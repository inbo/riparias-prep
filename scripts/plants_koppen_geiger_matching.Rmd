...
consisting of species that have at least 90 occurrences, which represent at least
20% of the total number of species occurrences, in the climate zones of Belgium, 
is created. 
...
data_redux <- data %>% 
  ...
  distinct(acceptedTaxonKey, acceptedScientificName, decimalLongitude, decimalLatitude) %>% 
