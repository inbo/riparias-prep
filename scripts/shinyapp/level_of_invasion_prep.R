...
occupancy_RBSU_temp<- occupancy_RBSU_temp %>% select(c('A0_CODE', 'scientific_name', 'state', 'level_of_invasion'))
...
occupancy_RBU_temp<- occupancy_RBU_temp %>% select(c('RBU', 'scientific_name', 'state', 'level_of_invasion'))
