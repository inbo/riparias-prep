...
if(file.exists("~/GitHub/riparias-prep/data/spatial/baseline/points_in_perimeter_sel.geojson")){
  file.remove("~/GitHub/riparias-prep/data/spatial/baseline/points_in_perimeter_sel.geojson")
}
...
if(file.exists("~/GitHub/riparias-prep/data/spatial/baseline/baseline.geojson")){
  file.remove("~/GitHub/riparias-prep/data/spatial/baseline/baseline.geojson")
}
...
if(file.exists("~/GitHub/riparias-prep/data/spatial/baseline/current_state.geojson")){
  file.remove("~/GitHub/riparias-prep/data/spatial/baseline/current_state.geojson")
}
